...
# 项目根目录（src 的上一级），用于定位 config.json 与日志
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# 配置日志
logger.remove()
logger.add(os.path.join(PROJECT_ROOT, "trojan_client.log"), rotation="10MB", retention="7 days", level="INFO", backtrace=True, diagnose=True)
